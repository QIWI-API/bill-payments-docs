...
<aside class="notice">
При открытии формы в webview на android, то обязательно включать settings.setDomStorageEnabled(true)
</aside>
...
| Параметр | Описание | Тип |
|--------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| paySource | При открытии формы сразу будет выбран способ оплаты. Возможные значения:<br><i>qw - QIWI Кошелек</i>> <br><i>card - банковская карта</i> <br><i>mobile - платеж со счета мобильного телефона</i> <br><i>sovest - карта СОВЕСТЬ</i> <br> Если способ оплаты недоступен - выбирается рекомендуемый способ оплаты | String
