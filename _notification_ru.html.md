...
status | Объект статуса счета | Hashmap: <br> "value" - строковое значение статуса (String) <br> "update_datetime" - Дата обновления статуса (URL-закодированная строка ГГГГ-ММ-ДДTЧЧ:ММ:СС)
