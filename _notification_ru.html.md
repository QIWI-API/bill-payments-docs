...

{
  "bill": {
    ...
    "currency": "RUB",
    "status": "PAID",  
    "status_update_datetime" : "2017-12-27T16:01:00Z",
    "user": {
      "phone": "79261234567", 
      "account" : "dsfc2recd123sdadx3dscfewcr234esdcf23", 
...
1. Получить строку, содержащую значения следующих параметров POST-запроса в алфавитном порядке, разделенных символами `|`:
    
   amount|bill_id|currency|prv_id|status

   Все значения при проверке подписи должны трактоваться как строки.
